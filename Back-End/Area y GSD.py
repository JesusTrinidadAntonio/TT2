...
perimeter_m = round(perimetro_total * pixel_large,3)

# Contar los píxeles blancos y calcular el área total
white_pixels_count = np.sum(binary_image == 255)
total_area_m2 = round(white_pixels_count * pixel_size,3)
...
def store_results(perimeter_m, total_area_m2, fecha):
    ...
    resultados['area'] = f"{resultados['area']} m²"
    resultados['perimetro'] = f"{resultados['perimetro']} m"
